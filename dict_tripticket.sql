...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2017 at 08:07 AM
...
--
-- Database: `dict_tripticket`
--
CREATE DATABASE IF NOT EXISTS `dict_tripticket` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `dict_tripticket`;
